...
class _HomeState extends State<Home> {
  ...
  getNewsByQuery(String query) async {
    Map element;
    int i = 0;
    String url = "https://newsapi.org/v2/top-headlines?country=in&apiKey=196b775e23c44c95891f56a370f55874";
  ...
  getNewsofIndia() async {
    String url =
        "https://newsapi.org/v2/top-headlines?country=in&apiKey=196b775e23c44c95891f56a370f55874";
    Response response = await get(Uri.parse(url));
    Map data = jsonDecode(response.body);
    setState(() {
